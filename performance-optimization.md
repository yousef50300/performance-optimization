...
<h1 id="welcome-to-performance-optimization">Welcome to Performance optimization!</h1>
<ul>
<li>
<p>don’t evaluate in your loop condition , do it once before the loop</p>
<pre><code>    for($i = 0, $count = count($array); $i &lt; $count; $i++)
</code></pre>
</li>
<li>
<p>avoid doing database queries inside loops do an aggregate query instead</p>
</li>
<li>
<p>use empty($array) instead of count( $array) === 0</p>
</li>
<li>
<p>use $a === $b instead of strcmp( $a , $b) === 0</p>
</li>
<li>
<p>use single quotes instead of double quotes unless you 're concatenating variables</p>
</li>
<li></li>
</ul>
